...
namespace hamdb
{
    ...
    public:
        ...
        [[nodiscard]] auto getTransactionId() const noexcept -> txn_id_t
        {
            return txn_id_;
        }
        [[nodiscard]] auto getState() const noexcept -> TransactionState
        {
            return state_;
        }
        [[nodiscard]] auto getBeginTimestamp() const noexcept -> timestamp_t
        {
            return begin_ts_;
        }
        [[nodiscard]] auto getCommitTimestamp() const noexcept -> timestamp_t
        {
            return commit_ts_;
        }
        ...
        void setBeginTimestamp(timestamp_t ts) noexcept
        {
            begin_ts_ = ts;
        }
        void setCommitTimestamp(timestamp_t ts) noexcept
        {
            commit_ts_ = ts;
        }

        [[nodiscard]] auto
        getSharedLockSet() const noexcept -> const std::unordered_set<RID, RIDHash>&
        {
            return shared_lock_set_;
        }
        [[nodiscard]] auto getSharedLockSet() noexcept -> std::unordered_set<RID, RIDHash>&
        {
            return shared_lock_set_;
        }

        [[nodiscard]] auto
        getExclusiveLockSet() const noexcept -> const std::unordered_set<RID, RIDHash>&
        {
            return exclusive_lock_set_;
        }
        [[nodiscard]] auto getExclusiveLockSet() noexcept -> std::unordered_set<RID, RIDHash>&
        {
            return exclusive_lock_set_;
        }
