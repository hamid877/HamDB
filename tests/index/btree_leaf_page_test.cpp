...
namespace hamdb
{
    ...
    TEST(BTreeLeafPageTest, KeyAndValueAtMultipleSlots)
    {
        ...
        EXPECT_EQ(lp.keyAt(0), 100);
        EXPECT_EQ(lp.valueAt(0), (RID{kPage1, 0}));
        EXPECT_EQ(lp.keyAt(1), 200);
        EXPECT_EQ(lp.valueAt(1), (RID{kPage2, 1}));
        EXPECT_EQ(lp.keyAt(2), 300);
        EXPECT_EQ(lp.valueAt(2), (RID{kPage3, 2}));
    }
    ...
    TEST(BTreeLeafPageTest, SerializeDeserializeWithEntries)
    {
        ...
        EXPECT_EQ(decoded.keyAt(0), 100);
        EXPECT_EQ(decoded.valueAt(0), (RID{kPage1, 0}));
        EXPECT_EQ(decoded.keyAt(1), 200);
        EXPECT_EQ(decoded.valueAt(1), (RID{kPage2, 1}));
        EXPECT_EQ(decoded.keyAt(2), 300);
        EXPECT_EQ(decoded.valueAt(2), (RID{kPage3, 2}));
    }
