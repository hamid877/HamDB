...
namespace hamdb
{
    ...
    DeleteExecutor::DeleteExecutor(ExecutorContext* exec_ctx, const TableInfo* table_info,
    ...
    bool DeleteExecutor::next(Tuple* tuple, RID* rid)
    {
        ...
        while (child_executor_->next(&child_tuple, &child_rid))
        {
            ...
            LogRecord log(txn->getTransactionId(), LogRecordType::DELETE, kInvalidLSN, child_rid,
                          child_tuple);
            log_mgr->append(log);
